import { getGarage } from "./getGarage.js";
import { getWinners } from "./racings.js";
import { currentWinnerPage } from "./variables.js";
import { winnersPage, winnersList } from "./pageElements.js";
import { winnersPageButton } from "./pagination.js";
...
async function winnersCounter() {
  ...
  for (let number of winnerNumbers) {
    if (winnersPageButton.innerHTML == 1) {
      ...
      number.innerHTML = (currentWinnerPage - 1) * 10 + counter;
      counter++;
    }
  }
}

export { createWinnerList, winnersList };
